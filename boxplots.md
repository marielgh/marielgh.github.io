...
<pre style="background-color:white"><code>['assistance', 'benefit', 'bus driver',
 'childhood', 'clinic assistant', 'counselor', 'custodian', 'disadvantaged', 'driver', 'early childhood',
 'employee benefit', 'food service', 'gifted',
 'medium', 'nurse', 'nutrition', 'overtime', 'personnel', 'principal',
 'psychological', 'recruitment',
 'regular', 'security', 'service', 'social', 'social worker',
 'special education', 'speech', 'substitute',
 'substitute teacher', 'supply', 'support personnel', 'talented', 'targeted',
 'targeted assistance', 'teacher', 'title',
 'transportation']</code></pre>
